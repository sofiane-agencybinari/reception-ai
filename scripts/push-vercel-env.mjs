...
const KEYS = [
  ...
  "NEXT_PUBLIC_PILOTE_RESTAURANT_NAME",
  "NEXT_PUBLIC_ELBAHJA_LOGIN_ID",
  "NEXT_PUBLIC_ELBAHJA_LOGIN_PASSWORD",
  "NEXT_PUBLIC_ELBAHJA_RESTAURANT_ID",
  "NEXT_PUBLIC_ELBAHJA_RESTAURANT_NAME",
  "NEXT_PUBLIC_ELBAHJA_AGENT_ID",
  "NEXT_PUBLIC_APP_URL",
